		    ...
		    <div class="wrapper1">
			  	...
			  	<div class="ml-5">
				    <c:if test="${pageContext.request.userPrincipal.name != null}">
				        ...
				        <h2>Payees | <a onclick="document.forms['logoutForm'].submit()">Logout</a></h2>
			        </c:if>
			        
			        <div align="center" class="ml-5">
					    <h4 class="mt-5"><a class="text-decoration-none" href="add-payee">Add Payee</a></h4>
					    <table border="2" cellpadding="5" class="mt-4">
					        ...
					        <tr>
					        	 <td class="pl-3 pr-3">${payee.payeeName}</td>
					        	 <td class="pl-3 pr-3">${payee.id}</td>
					           	<td class="pl-3 pr-3">
					                <a href="deletePayee?id=${payee.id}">Delete</a>
					            </td>
					        </tr>
					        </c:forEach>
  						</table>
