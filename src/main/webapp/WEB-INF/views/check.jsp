	    ...
	    <div class="logic-page w-100">
		    <div class="wrapper1 w-100">
			  	...
			  	<div class="ml-5 width-100">
				    ...
				    <div class="container border mt-5  border-secondary width-100">
				        <div class="card  border-secondary mt-3 mb-3">
					        <div class="card-body">
					        	<div class="row">
					        		<div class="col">
					        				<div class="row">${cheque.account.name}</div>
					        				<div class="row">${cheque.account.address}</div>
					        		</div>
					        	...
					        	<div class="row">
					        		<div class="col"></div>
					        		<div class="col" align="right">Date: ${cheque.date}</div>
					        	</div>
					        	<div class="row">
					        		<div class="col-8 font-weight-light mr-2">Order of: ----${cheque.payee.payeeName}--</div>
					        	...
					        	<div class="row mt-1">
					        		<div class="col accNum">A${cheque.account.accountNumber}A</div>
		        	...
		        	<div class="mt-5"><span class="mr-4"><a href="download-check" download class="text-white rounded bg-secondary pt-2 pb-2 pl-4 pr-4">Download</a></span><a class="text-white rounded bg-secondary pt-2 pb-2 pl-4 pr-4" href="cheques">View Checks History</a></div>
		  </div>
	 </div>
